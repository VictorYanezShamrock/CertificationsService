...
public partial class Rdr1
{
    ...
    public string? USifCustPnrev { get; set; }

    public short? USifWonumb { get; set; }

    public string? USifCustPn { get; set; }

    public string? USifCustPo { get; set; }

    public string? USifCustPartRev { get; set; }

    public string? USifWhirlPs { get; set; }

    public short? USifPolineNum { get; set; }

    public decimal? USifBidStdNumb { get; set; }

    public decimal? USifWhTrnfrCstEa { get; set; }

    public DateTime? USifVendProm { get; set; }

    public string? USifPoCustNumb { get; set; }

    public DateTime? USifCustRequ { get; set; }

    public int? UA1wmsRmaqty { get; set; }

    public string? UA1wmsComments { get; set; }

    public DateTime? USifPromShipDt { get; set; }

    public string? USifSinqnumb { get; set; }

    public string? UPcnumb { get; set; }

    public string? UPmxLoco { get; set; }

    public string? UPmxQysc { get; set; }

    public decimal? UPmxRipi { get; set; }

    public string? UPmxIslc { get; set; }

    public string? UPmxIswa { get; set; }

    public string? UPmxQuan { get; set; }

    public string? UPmxBatc { get; set; }

    public string? UPmxBat2 { get; set; }

    public string? UPmxBbdt { get; set; }

    public string? UPmxLuid { get; set; }

    public string? UPmxBaty { get; set; }

    public int? UPmxBaen { get; set; }

    public int? UPmxBali { get; set; }

    public string? UPmxSenu { get; set; }

    public int? UPmxPrdb { get; set; }

    public int? UPmxPrdr { get; set; }

    public int? UPmxPrde { get; set; }

    public int? UPmxPrdl { get; set; }

    public string? UPmxSscc { get; set; }

    public string UPmxEx3p { get; set; } = null!;

    public string? UPmxPqy2 { get; set; }

    public decimal? UPmxIqty { get; set; }

    public decimal? UPmxQty2 { get; set; }

    public string? UPmxUom2 { get; set; }

    public string? UPmxSulr { get; set; }

    public string? UPmxRsnc { get; set; }

    public string? UPmxUftx { get; set; }

    public string? UPmxSpnr { get; set; }

    public decimal? UPmxU2tu { get; set; }

    public string? UPmxAmba { get; set; }

    public string? UPmxSqop { get; set; }

    public decimal? UPmxPatq { get; set; }

    public string? UPmxPaty { get; set; }

    public string? UPmxBac1 { get; set; }

    public string? UPmxBav1 { get; set; }

    public string? UPmxBac2 { get; set; }

    public string? UPmxBav2 { get; set; }

    public string? UPmxBac3 { get; set; }

    public string? UPmxBav3 { get; set; }

    public string? UPmxMqu2 { get; set; }

    public decimal? UPmxFree { get; set; }

    public int? UPmxShlf { get; set; }

    public string? UPmxSloc { get; set; }

    public string? UPmxSqsc { get; set; }

    public string? UPmxSlui { get; set; }

    public string? UPmxMlui { get; set; }

    public string? UPmxRlco { get; set; }

    public string? UTwbsPalletLineUniqueId { get; set; }
}
